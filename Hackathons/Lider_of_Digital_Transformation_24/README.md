...
psql test
```
### Устанавливаем расширение для созданной БД
```cmd
...
```
## **Работа с сервисом**
### *Для тестовой демонстрации к сервису организован удаленный доступ с применение туннелирования (сервис Ngrok) поэтому вы уже можете начать им пользоваться*
