...
if __name__ == '__main__':
    ...
    # Значения в поле id таблицы Course выберутся те, что будут равны значениям в поле course_id результата подзапроса
    # Результаты подзапроса ВСЕГДА храняться в поле "c"
