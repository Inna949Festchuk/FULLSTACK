...
-- N:M студент записывается на курсы, курсы содержат студентов в этом случае используется составной ключ
-- и если студент записан на курс с идентификатором 1 повторно он записаться на него не сможет
...
-- студенты отправляют ДЗ на проверку но могут повторно отправить дз на проверку после доработки
