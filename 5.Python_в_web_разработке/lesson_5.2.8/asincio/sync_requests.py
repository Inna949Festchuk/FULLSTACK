# Классический синхронный подход
import datetime

import requests

def get_people(person_id):
    # return requests.get(f'http://127.0.0.1:5000/press/{person_id}').json()
    return requests.get(f'http://swapi.py4e.com/api/people/{person_id}').json()
