...
- [13 инструментов для обработки текста в командной оболочке](https://habr.com/ru/companies/itsumma/articles/492932/)
- [15 полезных примеров использования команды touch в Linux системах](https://omgubuntu.ru/15-polieznykh-primierov-ispolzovaniia-komandy-touch-v-sistiemakh-linux/)
- [Введение в Bash Shell](https://habr.com/ru/articles/471242/)
- [Как работает bash: разбираемся в деталях](https://cloud.vk.com/blog/detali-raboty-bash)
- [Написание скриптов в Linux Bash](https://help.reg.ru/support/servery-vps/oblachnyye-servery/rabota-s-serverom/napisaniye-skriptov-v-linux-bash)
...
- [Управление услугой «Облачные серверы»](https://help.reg.ru/support/servery-vps/oblachnyye-servery/zakaz-i-upravleniye-uslugoy-oblachnyye-servery/upravleniye-uslugoy-oblachnyye-servery?utm_source=guide&utm_medium=event&utm_campaign=netology-python)

- [SSH-ключи для Облачных серверов (Создание ключа)](https://help.reg.ru/support/servery-vps/oblachnyye-servery/rabota-s-serverom/ssh-klyuchi-dlya-oblachnykh-serverov#2)
- [Управление услугой «Облачные серверы» (Создание, удаление сервера и др.)](https://help.reg.ru/support/servery-vps/oblachnyye-servery/zakaz-i-upravleniye-uslugoy-oblachnyye-servery/upravleniye-uslugoy-oblachnyye-servery#0)
